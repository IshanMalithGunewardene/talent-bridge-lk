...
import { PREPENDED_CLASS_NAMES, VIEWS, en as en_default, generateClassNames, merge, template } from "./@supabase_auth-ui-shared.js";

//#region node_modules/@stitches/core/dist/index.mjs
var e$1, t = "colors", n = "sizes", r = "space", i = {
	gap: r,
	gridGap: r,
	columnGap: r,
	gridColumnGap: r,
	...
	zIndex: "zIndices"
}, o = (e, t) => "function" == typeof t ? { "()": Function.prototype.toString.call(t) } : t, l = () => {
	...
	return !1;
}, { hasOwnProperty: d } = Object.prototype, g = (e) => e.includes("-") ? e : e.replace(/[A-Z]/g, ((e) => "-" + e.toLowerCase())), p = /\s+(?![^()]*\))/, u$1 = (e) => (t) => e(..."string" == typeof t ? String(t).split(p) : [t]), h = {
	appearance: (e) => ({
		WebkitAppearance: e,
		appearance: e
	}),
	...
	paddingBlock: u$1(((e, t) => ({
		paddingBlockStart: e,
		paddingBlockEnd: t || e
	}))),
	paddingInline: u$1(((e, t) => ({
		paddingInlineStart: e,
		paddingInlineEnd: t || e
	})))
}, f = /([\d.]+)([^]*)/, m = (e, t) => e.length ? e.reduce(((e, n) => (e.push(...t.map(((e) => e.includes("&") ? e.replace(/&/g, /[ +>|~]/.test(n) && /&.*&/.test(e) ? `:is(${n})` : n) : n + " " + e))), e)), []) : t, b = (e, t) => e in S$1 && "string" == typeof t ? t.replace(/^((?:[^]*[^\w-])?)(fit-content|stretch)((?:[^\w-][^]*)?)$/, ((t, n, r, i) => n + ("stretch" === r ? `-moz-available${i};${g(e)}:${n}-webkit-fill-available` : `-moz-fit-content${i};${g(e)}:${n}fit-content`) + i)) : String(t), S$1 = {
	blockSize: 1,
	height: 1,
	inlineSize: 1,
	maxBlockSize: 1,
	...
	const a = (e, t, n) => {
		...
		const p = (e) => {
			for (c in e) {
				const x = 64 === c.charCodeAt(0);
				for (d of x && Array.isArray(e[c]) ? e[c] : [e[c]]) {
					...
					if (x && (u = c.slice(1) in r.media ? "@media " + r.media[c.slice(1)] : c, c = u.replace(/\(\s*([\w-]+)\s*(=|<|<=|>|>=)\s*([\w-]+)\s*(?:(<|<=|>|>=)\s*([\w-]+)\s*)?\)/g, ((e, t, n, r, i, o) => {
						const l = f.test(t), s = .0625 * (l ? -1 : 1), [a, c] = l ? [r, t] : [t, r];
						...
						const e = x ? n.concat(c) : [...n], r = x ? [...t] : m(t, c.split(B));
						void 0 !== o && i(I(...o)), o = void 0, a(d, r, e);
					} else void 0 === o && (o = [
						[],
						t,
						n
					]), c = x || 36 !== c.charCodeAt(0) ? c : `--${k(r.prefix)}${c.slice(1).replace(/\$/g, "-")}`, d = z ? d : "number" == typeof d ? d && e in R$1 ? String(d) + "px" : String(d) : y(b(e, null == d ? "" : d), r.prefix, r.themeMap[e]), o[0].push(`${x ? `${c} ` : `${g(c)}:`}${d}`);
				}
			}
			var u, S;
		};
	...
	a(e, t, n);
}, I = (e, t, n) => `${n.map(((e) => `${e}{`)).join("")}${t.length ? `${t.join(",")}{` : ""}${e.join(";")}${t.length ? "}" : ""}${Array(n.length ? n.length + 1 : 0).join("}")}`, R$1 = {
	animationDelay: 1,
	animationDuration: 1,
	backgroundSize: 1,
	blockSize: 1,
	...
	const n = () => {
		...
		return [].map.call(e, ((n, r) => {
			...
			if (e[r - 1] && (o = e[r - 1].cssText).startsWith("--sxs")) {
				...
				for (const e in t.rules) if (t.rules[e].group === n) return `--sxs{--sxs:${[...t.rules[e].cache].join(" ")}}${i}`;
	...
	} else t.constructor !== Object || t.$$typeof ? r.type ??= t : r.composers.add(P(t, e));
	return r.type ??= "span", r.composers.size || r.composers.add([
		"PJLV",
		{},
		[],
		[],
	...
	const [r, i, o, l] = O(t.composers), c = "function" == typeof t.type || t.type.$$typeof ? ((e) => {
		...
		return t[M] = [], t.rules = {}, j.forEach(((e) => t.rules[e] = { apply: (n) => t[M].push([e, n]) })), t;
	})(n) : null, d = (c || n).rules, g = `.${r}${i.length > 1 ? `:where(.${i.slice(1).join(".")})` : ""}`, p = (s) => {
		s = "object" == typeof s && s || D$1;
		const { css: a, ...p } = s, u = {};
		...
		for (const [r, i, o, l] of t.composers) {
			...
			for (const i of t) if (void 0 !== i) for (const [t, o, l] of i) {
				...
				s.has(i) || (s.add(i), x(o, [`.${i}`], [], e, ((e) => {
					a.apply(e);
				})));
			}
			for (const t of s) if (void 0 !== t) for (const [i, o] of t) {
				const t = `${r}-${W(o)}-${i}`;
				h.add(t), n.rules.allvar.cache.has(t) || (n.rules.allvar.cache.add(t), x(o, [`.${t}`], [], e, ((e) => {
					d.allvar.apply(e);
				})));
			}
		}
		if ("object" == typeof a && a) {
			const t = `${r}-i${W(a)}-css`;
			h.add(t), n.rules.inline.cache.has(t) || (n.rules.inline.cache.add(t), x(a, [`.${t}`], [], e, ((e) => {
				d.inline.apply(e);
			})));
		}
	...
	for (const t in r) {
		...
		for (const n in r[t]) {
			...
			o[t][n] = new F$1(n, s, t, e.prefix), l.push(`${i}:${s}`);
		}
	}
	const s = () => {
	...
	return t || n.reset(), n;
}, Y = () => e$1 || (e$1 = X$1()), q = (...e) => Y().createTheme(...e), K = (...e) => Y().globalCss(...e), Q$1 = (...e) => Y().keyframes(...e), _ = (...e) => Y().css(...e);

//#endregion
//#region node_modules/@supabase/auth-ui-react/dist/index.es.js
...
var g1 = _({
	...
	var o;
	const r = generateClassNames("anchor", g1(), l);
	...
	variants: { color: {
		default: {
			...
			"&:hover:not(:disabled)": { backgroundColor: "$defaultButtonBackgroundHover" }
		},
		primary: {
	...
	var C;
	const E = generateClassNames("button", h1({ color: l }), n);
	...
	var o;
	const r = generateClassNames("container", f1({
	...
	var o;
	const r = generateClassNames("divider", E1(), l);
	return /* @__PURE__ */ import_react.createElement("div", {
		...n,
	...
	var o;
	const r = generateClassNames("input", w1({ type: n.type === "password" ? "password" : "default" }), l);
	...
	var o;
	const r = generateClassNames("label", v1(), l);
	...
	var o;
	const r = generateClassNames("message", x1({ color: n.color }), l);
...
function X({ setAuthView: t = () => {}, supabaseClient: l, redirectTo: n, i18n: r, appearance: o, showLinks: v = !1 }) {
	var _;
	const [E, C] = (0, import_react.useState)(""), [w, d] = (0, import_react.useState)(""), [i, m] = (0, import_react.useState)(""), [c, y] = (0, import_react.useState)(!1), x = async (h) => {
		var s, M;
	...
	return /* @__PURE__ */ import_react.createElement("form", {
		id: "auth-magic-link",
		onSubmit: x
	}, /* @__PURE__ */ import_react.createElement(N, {
		gap: "large",
		direction: "vertical",
		appearance: o
	}, /* @__PURE__ */ import_react.createElement("div", null, /* @__PURE__ */ import_react.createElement(H, {
		htmlFor: "email",
		appearance: o
	}, a == null ? void 0 : a.email_input_label), /* @__PURE__ */ import_react.createElement(D, {
		id: "email",
		name: "email",
		type: "email",
		autoFocus: !0,
		...
		loading: c,
		appearance: o
	}, c ? a == null ? void 0 : a.loading_button_label : a == null ? void 0 : a.button_label), v && /* @__PURE__ */ import_react.createElement(V, {
		href: "#auth-sign-in",
		onClick: (h) => {
			h.preventDefault(), t(VIEWS.SIGN_IN);
		},
		appearance: o
	}, (_ = r == null ? void 0 : r.sign_in) == null ? void 0 : _.link_text), i && /* @__PURE__ */ import_react.createElement(F, { appearance: o }, i), w && /* @__PURE__ */ import_react.createElement(F, {
		color: "danger",
		appearance: o
	}, w)));
}
var L = _({
	width: "21px",
	height: "21px"
}), _1 = ({ provider: t }) => t == "google" ? y1() : t == "facebook" ? L1() : t == "twitter" ? b1() : t == "apple" ? p1() : t == "github" ? k1() : t == "gitlab" ? M1() : t == "bitbucket" ? S1() : t == "discord" ? N1() : t == "azure" ? F1() : t == "keycloak" ? z1() : t == "linkedin" ? $1() : t == "notion" ? B1() : t == "slack" ? D1() : t == "spotify" ? H1() : t == "twitch" ? P1() : t == "workos" ? V1() : t == "kakao" ? I1() : null, y1 = () => /* @__PURE__ */ import_react.createElement("svg", {
	className: L(),
...
})), L1 = () => /* @__PURE__ */ import_react.createElement("svg", {
	className: L(),
	xmlns: "http://www.w3.org/2000/svg",
	viewBox: "0 0 48 48",
	width: "21px",
...
})), b1 = () => /* @__PURE__ */ import_react.createElement("svg", {
	className: L(),
	xmlns: "http://www.w3.org/2000/svg",
	viewBox: "0 0 48 48",
	width: "21px",
...
})), p1 = () => /* @__PURE__ */ import_react.createElement("svg", {
	className: L(),
	fill: "gray",
	xmlns: "http://www.w3.org/2000/svg",
	viewBox: "0 0 24 24",
	width: "21px",
	height: "21px"
}, " ", /* @__PURE__ */ import_react.createElement("path", { d: "M 15.904297 1.078125 C 15.843359 1.06875 15.774219 1.0746094 15.699219 1.0996094 C 14.699219 1.2996094 13.600391 1.8996094 12.900391 2.5996094 C 12.300391 3.1996094 11.800781 4.1996094 11.800781 5.0996094 C 11.800781 5.2996094 11.999219 5.5 12.199219 5.5 C 13.299219 5.4 14.399609 4.7996094 15.099609 4.0996094 C 15.699609 3.2996094 16.199219 2.4 16.199219 1.5 C 16.199219 1.275 16.087109 1.10625 15.904297 1.078125 z M 16.199219 5.4003906 C 14.399219 5.4003906 13.600391 6.5 12.400391 6.5 C 11.100391 6.5 9.9003906 5.5 8.4003906 5.5 C 6.3003906 5.5 3.0996094 7.4996094 3.0996094 12.099609 C 2.9996094 16.299609 6.8 21 9 21 C 10.3 21 10.600391 20.199219 12.400391 20.199219 C 14.200391 20.199219 14.600391 21 15.900391 21 C 17.400391 21 18.500391 19.399609 19.400391 18.099609 C 19.800391 17.399609 20.100391 17.000391 20.400391 16.400391 C 20.600391 16.000391 20.4 15.600391 20 15.400391 C 17.4 14.100391 16.900781 9.9003906 19.800781 8.4003906 C 20.300781 8.1003906 20.4 7.4992188 20 7.1992188 C 18.9 6.1992187 17.299219 5.4003906 16.199219 5.4003906 z" })), k1 = () => /* @__PURE__ */ import_react.createElement("svg", {
	className: L(),
	fill: "gray",
	xmlns: "http://www.w3.org/2000/svg",
	viewBox: "0 0 30 30",
	width: "21px",
	height: "21px"
}, " ", /* @__PURE__ */ import_react.createElement("path", { d: "M15,3C8.373,3,3,8.373,3,15c0,5.623,3.872,10.328,9.092,11.63C12.036,26.468,12,26.28,12,26.047v-2.051 c-0.487,0-1.303,0-1.508,0c-0.821,0-1.551-0.353-1.905-1.009c-0.393-0.729-0.461-1.844-1.435-2.526 c-0.289-0.227-0.069-0.486,0.264-0.451c0.615,0.174,1.125,0.596,1.605,1.222c0.478,0.627,0.703,0.769,1.596,0.769 c0.433,0,1.081-0.025,1.691-0.121c0.328-0.833,0.895-1.6,1.588-1.962c-3.996-0.411-5.903-2.399-5.903-5.098 c0-1.162,0.495-2.286,1.336-3.233C9.053,10.647,8.706,8.73,9.435,8c1.798,0,2.885,1.166,3.146,1.481C13.477,9.174,14.461,9,15.495,9 c1.036,0,2.024,0.174,2.922,0.483C18.675,9.17,19.763,8,21.565,8c0.732,0.731,0.381,2.656,0.102,3.594 c0.836,0.945,1.328,2.066,1.328,3.226c0,2.697-1.904,4.684-5.894,5.097C18.199,20.49,19,22.1,19,23.313v2.734 c0,0.104-0.023,0.179-0.035,0.268C23.641,24.676,27,20.236,27,15C27,8.373,21.627,3,15,3z" })), M1 = () => /* @__PURE__ */ import_react.createElement("svg", {
	className: L(),
	xmlns: "http://www.w3.org/2000/svg",
	viewBox: "0 0 48 48",
	width: "21px",
	...
	fill: "#ffa726",
	d: "M24 43L6 20 3 28z"
})), S1 = () => /* @__PURE__ */ import_react.createElement("svg", {
	className: L(),
	xmlns: "http://www.w3.org/2000/svg",
	width: "512",
	height: "512",
	viewBox: "0 0 62.42 62.42"
}, /* @__PURE__ */ import_react.createElement("defs", null, /* @__PURE__ */ import_react.createElement("linearGradient", {
...
}, /* @__PURE__ */ import_react.createElement("stop", {
	offset: "0.18",
	stopColor: "#0052cc"
}), /* @__PURE__ */ import_react.createElement("stop", {
	offset: "1",
	stopColor: "#2684ff"
}))), /* @__PURE__ */ import_react.createElement("title", null, "Bitbucket-blue"), /* @__PURE__ */ import_react.createElement("g", {
	id: "Layer_2",
	"data-name": "Layer 2"
...
})))), N1 = () => /* @__PURE__ */ import_react.createElement("svg", {
	className: L(),
	xmlns: "http://www.w3.org/2000/svg",
	viewBox: "0 0 48 48",
	width: "21px",
...
})), F1 = () => /* @__PURE__ */ import_react.createElement("svg", {
	className: L(),
	xmlns: "http://www.w3.org/2000/svg",
	viewBox: "0 0 48 48",
	width: "21px",
	height: "21px"
}, /* @__PURE__ */ import_react.createElement("linearGradient", {
...
})), z1 = () => /* @__PURE__ */ import_react.createElement("svg", {
	className: L(),
	width: "512",
	height: "512",
	viewBox: "0 0 512 512",
	...
	fill: "#008AAA"
})), $1 = () => /* @__PURE__ */ import_react.createElement("svg", {
	className: L(),
	xmlns: "http://www.w3.org/2000/svg",
	viewBox: "0 0 48 48",
	width: "21px",
	...
	clipRule: "evenodd"
})), D1 = () => /* @__PURE__ */ import_react.createElement("svg", {
	className: L(),
	xmlns: "http://www.w3.org/2000/svg",
	viewBox: "0 0 48 48",
	width: "21px",
...
})), H1 = () => /* @__PURE__ */ import_react.createElement("svg", {
	className: L(),
	width: "512",
	height: "512",
	viewBox: "0 0 512 512",
	...
	fill: "#9146FF"
})), V1 = () => /* @__PURE__ */ import_react.createElement("svg", {
	className: L(),
	width: "512",
	height: "512",
	viewBox: "0 0 512 512",
	...
	fill: "#6363F1"
})), I1 = () => /* @__PURE__ */ import_react.createElement("svg", {
	className: L(),
	xmlns: "http://www.w3.org/2000/svg",
	width: "2500",
	height: "2500",
...
}), /* @__PURE__ */ import_react.createElement("path", { d: "M128 36C70.562 36 24 72.713 24 118c0 29.279 19.466 54.97 48.748 69.477-1.593 5.494-10.237 35.344-10.581 37.689 0 0-.207 1.762.934 2.434s2.483.15 2.483.15c3.272-.457 37.943-24.811 43.944-29.04 5.995.849 12.168 1.29 18.472 1.29 57.438 0 104-36.712 104-82 0-45.287-46.562-82-104-82z" }), /* @__PURE__ */ import_react.createElement("path", {
	fill: "#FFE812",
...
function A1({ supabaseClient: t, socialLayout: l = "vertical", providers: n = [
	...
	const [i, m] = (0, import_react.useState)(!1), [c, y] = (0, import_react.useState)(""), x = l === "vertical", a = C === "magic_link" ? "sign_in" : C, _ = async (g) => {
		m(!0);
	...
	return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, n && n.length > 0 && /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, /* @__PURE__ */ import_react.createElement(N, {
		gap: "large",
		direction: "vertical",
		appearance: d
	}, /* @__PURE__ */ import_react.createElement(N, {
		...
		var s;
		return /* @__PURE__ */ import_react.createElement(U, {
			key: g,
			color: "default",
			loading: i,
			onClick: () => _(g),
			appearance: d
		}, /* @__PURE__ */ import_react.createElement(_1, { provider: g }), x && template((s = w == null ? void 0 : w[a]) == null ? void 0 : s.social_provider_text, { provider: h(g) }));
	}))), !E && /* @__PURE__ */ import_react.createElement(C1, { appearance: d })));
}
function Q({ authView: t = "sign_in", defaultEmail: l = "", defaultPassword: n = "", setAuthView: r = () => {}, setDefaultEmail: o = (x) => {}, setDefaultPassword: v = (x) => {}, supabaseClient: E, showLinks: C = !1, redirectTo: w, additionalData: d, magicLink: i, i18n: m, appearance: c, children: y }) {
	var T, G, Z, j;
	const x = (0, import_react.useRef)(!0), [a, _] = (0, import_react.useState)(l), [h, g] = (0, import_react.useState)(n), [s, M] = (0, import_react.useState)(""), [p, B] = (0, import_react.useState)(!1), [P, A] = (0, import_react.useState)("");
	(0, import_react.useEffect)(() => (x.current = !0, _(l), g(n), () => {
		x.current = !1;
	}), [t]);
	const O = async (k) => {
		var q;
	...
	return /* @__PURE__ */ import_react.createElement("form", {
		...
		htmlFor: "email",
		appearance: c
	}, f == null ? void 0 : f.email_label), /* @__PURE__ */ import_react.createElement(D, {
		id: "email",
		type: "email",
		name: "email",
		...
		htmlFor: "password",
		appearance: c
	}, f == null ? void 0 : f.password_label), /* @__PURE__ */ import_react.createElement(D, {
		id: "password",
		type: "password",
		name: "password",
		...
		appearance: c
	})), y), /* @__PURE__ */ import_react.createElement(U, {
		type: "submit",
		color: "primary",
		loading: p,
		appearance: c
	}, p ? f == null ? void 0 : f.loading_button_label : f == null ? void 0 : f.button_label), C && /* @__PURE__ */ import_react.createElement(N, {
		direction: "vertical",
		gap: "small",
		appearance: c
	}, t === VIEWS.SIGN_IN && i && /* @__PURE__ */ import_react.createElement(V, {
		href: "#auth-magic-link",
		onClick: (k) => {
			k.preventDefault(), r(VIEWS.MAGIC_LINK);
		},
		appearance: c
	}, (T = m == null ? void 0 : m.magic_link) == null ? void 0 : T.link_text), t === VIEWS.SIGN_IN && /* @__PURE__ */ import_react.createElement(V, {
		href: "#auth-forgot-password",
		onClick: (k) => {
			k.preventDefault(), r(VIEWS.FORGOTTEN_PASSWORD);
		},
		appearance: c
	}, (G = m == null ? void 0 : m.forgotten_password) == null ? void 0 : G.link_text), t === VIEWS.SIGN_IN ? /* @__PURE__ */ import_react.createElement(V, {
		href: "#auth-sign-up",
		onClick: (k) => {
			k.preventDefault(), z(VIEWS.SIGN_UP);
		},
		appearance: c
	}, (Z = m == null ? void 0 : m.sign_up) == null ? void 0 : Z.link_text) : /* @__PURE__ */ import_react.createElement(V, {
		href: "#auth-sign-in",
		onClick: (k) => {
			k.preventDefault(), z(VIEWS.SIGN_IN);
		},
		appearance: c
	}, (j = m == null ? void 0 : m.sign_in) == null ? void 0 : j.link_text))), P && /* @__PURE__ */ import_react.createElement(F, { appearance: c }, P), s && /* @__PURE__ */ import_react.createElement(F, {
		color: "danger",
		appearance: c
	}, s));
}
function e1({ setAuthView: t = () => {}, supabaseClient: l, redirectTo: n, i18n: r, appearance: o, showLinks: v = !1 }) {
	...
	const [E, C] = (0, import_react.useState)(""), [w, d] = (0, import_react.useState)(""), [i, m] = (0, import_react.useState)(""), [c, y] = (0, import_react.useState)(!1), x = async (h) => {
		...
		const { error: g } = await l.auth.resetPasswordForEmail(E, { redirectTo: n });
	...
	return /* @__PURE__ */ import_react.createElement("form", {
		...
		htmlFor: "email",
		appearance: o
	}, a == null ? void 0 : a.email_label), /* @__PURE__ */ import_react.createElement(D, {
		id: "email",
		name: "email",
		type: "email",
		autoFocus: !0,
...
function t1({ supabaseClient: t, i18n: l, appearance: n }) {
	const [r, o] = (0, import_react.useState)(""), [v, E] = (0, import_react.useState)(""), [C, w] = (0, import_react.useState)(""), [d, i] = (0, import_react.useState)(!1), m = async (y) => {
		var a;
	...
	return /* @__PURE__ */ import_react.createElement("form", {
		...
		htmlFor: "password",
		appearance: n
	}, c == null ? void 0 : c.password_label), /* @__PURE__ */ import_react.createElement(D, {
		id: "password",
		name: "password",
		...
		loading: d,
		appearance: n
	}, d ? c == null ? void 0 : c.loading_button_label : c == null ? void 0 : c.button_label), C && /* @__PURE__ */ import_react.createElement(F, { appearance: n }, C), v && /* @__PURE__ */ import_react.createElement(F, {
		color: "danger",
		appearance: n
	}, v)));
}
function U1({ setAuthView: t = () => {}, supabaseClient: l, otpType: n = "email", i18n: r, appearance: o, showLinks: v = !1 }) {
	var M;
	const [E, C] = (0, import_react.useState)(""), [w, d] = (0, import_react.useState)(""), [i, m] = (0, import_react.useState)(""), [c, y] = (0, import_react.useState)(""), [x, a] = (0, import_react.useState)(""), [_, h] = (0, import_react.useState)(!1), g = async (p) => {
	...
	return /* @__PURE__ */ import_react.createElement("form", {
		...
		direction: "vertical",
		appearance: o
	}, ["sms", "phone_change"].includes(n) ? /* @__PURE__ */ import_react.createElement("div", null, /* @__PURE__ */ import_react.createElement(H, {
		htmlFor: "phone",
		appearance: o
	}, s == null ? void 0 : s.phone_input_label), /* @__PURE__ */ import_react.createElement(D, {
		id: "phone",
		name: "phone",
		type: "text",
		autoFocus: !0,
		...
		htmlFor: "email",
		appearance: o
	}, s == null ? void 0 : s.email_input_label), /* @__PURE__ */ import_react.createElement(D, {
		id: "email",
		name: "email",
		type: "email",
		autoFocus: !0,
		...
		htmlFor: "token",
		appearance: o
	}, s == null ? void 0 : s.token_input_label), /* @__PURE__ */ import_react.createElement(D, {
		id: "token",
		name: "token",
		type: "text",
		...
		loading: _,
		appearance: o
	}, _ ? s == null ? void 0 : s.loading_button_label : s == null ? void 0 : s.button_label), v && /* @__PURE__ */ import_react.createElement(V, {
		href: "#auth-sign-in",
		onClick: (p) => {
			p.preventDefault(), t(VIEWS.SIGN_IN);
		},
		appearance: o
	}, (M = r == null ? void 0 : r.sign_in) == null ? void 0 : M.link_text), x && /* @__PURE__ */ import_react.createElement(F, { appearance: o }, x), c && /* @__PURE__ */ import_react.createElement(F, {
		color: "danger",
		appearance: o
	}, c)));
}
var l1 = (0, import_react.createContext)({
	user: null,
	session: null
}), R1 = (t) => {
	const { supabaseClient: l } = t, [n, r] = (0, import_react.useState)(null), [o, v] = (0, import_react.useState)((n == null ? void 0 : n.user) ?? null);
	...
	return /* @__PURE__ */ import_react.createElement(l1.Provider, {
		value: E,
		...t
	});
}, O1 = () => {
	const t = (0, import_react.useContext)(l1);
	if (t === void 0) throw new Error("useUser must be used within a UserContextProvider.");
	return t;
};
function S({ supabaseClient: t, socialLayout: l = "vertical", providers: n, providerScopes: r, queryParams: o, view: v = "sign_in", redirectTo: E, onlyThirdPartyProviders: C = !1, magicLink: w = !1, showLinks: d = !0, appearance: i, theme: m = "default", localization: c = { variables: {} }, otpType: y = "email", additionalData: x, children: a }) {
	const _ = merge(en_default, c.variables ?? {}), [h, g] = (0, import_react.useState)(v), [s, M] = (0, import_react.useState)(""), [p, B] = (0, import_react.useState)(""), P = h === "sign_in" || h === "sign_up" || h === "magic_link";
	(0, import_react.useEffect)(() => {
		var z, f;
		X$1({ theme: merge(((z = i == null ? void 0 : i.theme) == null ? void 0 : z.default) ?? {}, ((f = i == null ? void 0 : i.variables) == null ? void 0 : f.default) ?? {}) });
	}, [i]);
	const A = ({ children: z }) => {
		var f;
		return /* @__PURE__ */ import_react.createElement("div", { className: m !== "default" ? q(merge(i == null ? void 0 : i.theme[m], ((f = i == null ? void 0 : i.variables) == null ? void 0 : f[m]) ?? {})) : "" }, P && /* @__PURE__ */ import_react.createElement(A1, {
			appearance: i,
			supabaseClient: t,
			providers: n,
			providerScopes: r,
	...
	switch (h) {
		case VIEWS.SIGN_IN: return /* @__PURE__ */ import_react.createElement(A, null, /* @__PURE__ */ import_react.createElement(Q, {
			...O,
			authView: "sign_in"
		}));
		case VIEWS.SIGN_UP: return /* @__PURE__ */ import_react.createElement(A, null, /* @__PURE__ */ import_react.createElement(Q, {
			appearance: i,
			supabaseClient: t,
			authView: "sign_up",
			setAuthView: g,
		...
		case VIEWS.FORGOTTEN_PASSWORD: return /* @__PURE__ */ import_react.createElement(A, null, /* @__PURE__ */ import_react.createElement(e1, {
			appearance: i,
			supabaseClient: t,
			setAuthView: g,
			redirectTo: E,
		...
		case VIEWS.MAGIC_LINK: return /* @__PURE__ */ import_react.createElement(A, null, /* @__PURE__ */ import_react.createElement(X, {
			appearance: i,
			supabaseClient: t,
			setAuthView: g,
			redirectTo: E,
		...
		case VIEWS.UPDATE_PASSWORD: return /* @__PURE__ */ import_react.createElement(t1, {
			appearance: i,
			supabaseClient: t,
			i18n: _
		});
		case VIEWS.VERIFY_OTP: return /* @__PURE__ */ import_react.createElement(U1, {
			appearance: i,
			supabaseClient: t,
			otpType: y,
			i18n: _
...
var W1 = _({
	...
	return /* @__PURE__ */ import_react.createElement("div", { className: n.join(" ") }, t);
}, q1 = (t) => /* @__PURE__ */ import_react.createElement(S, {
	showLinks: !1,
	...t,
	onlyThirdPartyProviders: !1,
	view: "sign_up"
}), K1 = (t) => /* @__PURE__ */ import_react.createElement(S, {
	showLinks: !1,
	...t,
	onlyThirdPartyProviders: !1,
	view: "sign_in"
}), Y1 = (t) => /* @__PURE__ */ import_react.createElement(S, {
	...t,
	view: "magic_link",
	showLinks: !1
}), J1 = (t) => /* @__PURE__ */ import_react.createElement(S, {
	...t,
	view: "sign_in",
	showLinks: !1,
...
}), X1 = (t) => /* @__PURE__ */ import_react.createElement(S, {
	...t,
	view: "update_password"
}), e0 = (t) => /* @__PURE__ */ import_react.createElement(S, {
	...t,
	view: "verify_otp"
});

//#endregion
export { S as Auth, j1 as AuthCard, Q1 as ForgottenPassword, Y1 as MagicLink, K1 as SignIn, q1 as SignUp, J1 as SocialAuth, X1 as UpdatePassword, e0 as VerifyOtp };
